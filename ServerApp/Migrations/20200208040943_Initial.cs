        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Public = table.Column<string>(type: "varchar(1)", nullable: true, defaultValue: "1"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Label = table.Column<string>(type: "varchar(32)", nullable: false),
                    Content = table.Column<string>(nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Order = table.Column<int>(nullable: false),
                    Required = table.Column<string>(type: "varchar(1)", nullable: true, defaultValue: "1"),
                    PollId = table.Column<long>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PollData_PollId",
                table: "PollData",
                column: "PollId");

            migrationBuilder.CreateIndex(
                name: "IX_PollData_Order_PollId",
                table: "PollData",
                columns: new[] { "Order", "PollId" },
                unique: true);
